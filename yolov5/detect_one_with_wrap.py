...
from yolov5.utils.general import non_max_suppression_landmark
...
def detect_one(model, image_path, device, wrap_path, locate_path):
    # Load model
    global points
    img_size = 640
    conf_thres = 0.3
    ...
    cv2.imwrite(locate_path, orgimg)
    # if cv2.waitKey(0) == ord('q'):  # q to quit
    #    raise StopIteration
    return points

def detect_with_wrap(image_path, wrap_path, locate_path):
    print("***********************************")
    ...
    points = detect_one(model, image_path, device, wrap_path, locate_path)
    return points


# if __name__ == '__main__':
#     device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
#     weights = './weights/best-yolov5x-e600.pt'
#     cfg_path = './models/yolov5x.yaml'
#     model = load_model(weights, cfg_path, device)
#     image_path = '../img/000000.jpg'
#     wrap_path = 'result/result.jpg'
#     locate_path = 'result/result_warp.jpg'
#     points = detect_one(model, image_path, device, wrap_path, locate_path)
#     print(points)

# detect_with_wrap('../img/000000.jpg','result/result.jpg', 'result/result_warp.jpg')